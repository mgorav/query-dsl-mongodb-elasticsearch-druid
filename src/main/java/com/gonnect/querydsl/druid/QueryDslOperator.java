...
public enum QueryDslOperator {
    ...
    QueryDslOperator(final ComparisonOperator operator) {
        this.operator = operator;
    }

    public static QueryDslOperator getSimpleOperator(final ComparisonOperator operator) {
